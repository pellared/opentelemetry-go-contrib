...
- Fix flakiness in `go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-lambda-go/otellambda/xrayconfig` tests by improving synchronization in the mock collector.
